...
export class CompanyLendersController {
    ...
    @Post('')
    @UseBefore(CompanyStatusGuard, AgreementSignatureGuard)
    async linkLender(
        @Req() req: Request,
    ...
    async updateLender(
        ...
        return this.lendersService.updateLender(companyId, userId, lenderId, request);
    }
    ...
    async toggleLenderStatus(
        ...
        return this.lendersService.toggleLenderStatus(companyId, userId, lenderId, request.active);
    }
}
